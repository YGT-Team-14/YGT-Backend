...
class UserManager(BaseUserManager):
    def create_user(self, user_id, password,  student_id, major ):
        user = self.model(
            user_id = user_id,
            major = major,
    ...
    def create_superuser(self, user_id, password, student_id=None,  major =None ):
        user = self.create_user(user_id, password,  student_id, major)
